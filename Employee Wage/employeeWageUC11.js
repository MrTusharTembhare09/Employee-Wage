...
const totalWage = employeeDailyDetails.reduce((total, day) => total + day.wageEarned, 0);
const totalHours = employeeDailyDetails.reduce((total, day) => total + day.hoursWorked, 0);
...
employeeDailyDetails.forEach((day) => {
...
const partTimeDays = employeeDailyDetails
...
const noWorkDays = employeeDailyDetails
